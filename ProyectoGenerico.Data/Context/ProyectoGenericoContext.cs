...
{
    public partial class ProyectoGenericoContext : DbContext, IProyectoGenericoContext
    {
        ...
        public ProyectoGenericoContext() : base("name=dbConn")
        {
        ...
        public ProyectoGenericoContext(bool lazyload) : base("name=dbConn")
        {
